...
public class CustomerLossController extends BaseController{
    ...
    public String  toRepreivePage(@PathVariable("lossId") Integer id, Model model){
        model.addAttribute("customerLoss",customerLossService.queryCustomerLossesById(id));
    ...
    public MessageModel updateCustomerLossState(Integer lossId, String lossReason){
        ...
        return new MessageModel("流失操作执行成功");
    }
}
